...
export default function Navbar() {
  ...
  return (
    <div className="bg-gradient-to-b to-slate-800 from-slate-700 w-full min-h-[60px]  text-white flex justify-between items-center fixed">
      <h1 className="font-signature text-4xl px-4 ml-8 hover:scale-110 duration-300">
        Priyansh
      </h1>
      <ScrollSpy activeClass="scale:105">
